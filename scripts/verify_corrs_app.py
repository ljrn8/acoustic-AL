...
class App:
    ...
    def __init__(self, root):
        ...
        self.action_button = tk.Button(self.root, text="Mark FP", command=self.on_button_click)
        ...
        self.open_button = tk.Button(self.root, text="!! Open Image Folder", command=self.open_folder)
